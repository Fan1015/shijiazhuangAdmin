        ...
        <div class="edit-con-foot">
          <div class="edit-con-foot-1">
            <div class="edit-con-foot-1-lf">
              <p style="width:160px; text-align:right">保障装备（设备）ID：</p>
              <p>JT1000000-002034</p>
            </div>
          ...
          <div class="edit-con-foot-1">
            <div class="edit-con-foot-1-lf">
              <p style="width:160px; text-align:right">保障装备（设备）型号：</p>
          ...
          <div class="edit-con-foot-2">
            <div class="edit-con-foot-2-input">
              ...
              <div class="edit-con-foot-2-input-number">
                ...
                <div>
                  长<a-input-number :min="1" :max="100000" :defaultValue="defaultValue" @change="onChange" />mm
                </div>
                <div>
                  宽<a-input-number :min="1" :max="100000" :defaultValue="defaultValue" @change="onChange" />mm
                </div>
                <div>
                  高<a-input-number :min="1" :max="100000" :defaultValue="defaultValue" @change="onChange" />mm
                </div>
              </div>
            </div>
          </div>
