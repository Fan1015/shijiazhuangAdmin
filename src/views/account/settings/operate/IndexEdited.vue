    ...
    <div class="edit-page">
      <div class="edit-con">
        ...
        <div class="edit-con-foot">
          ...
          <div class="edit-con-foot-1">
            <div class="edit-con-foot-1-lf">
              <p style="width:160px; text-align:right">装备名称：</p>
              <p class="">××××</p>
            </div>
            <div class="edit-con-foot-1-rg">
              <p>录入时间：</p>
          ...
          <div class="edit-con-foot-2">
            <div class="edit-con-foot-2-input">
              <p>故障时间：</p>
              <div class="">
                <a-input placeholder="自动获取" style="width: 320px" @search="onSearch" />
              </div>
            </div>
          </div>
          <div class="edit-con-foot-2">
        ...
        <div class="edit-con-foot">
          ...
          <div class="edit-con-foot-2">
            <div class="edit-con-foot-2-input">
              <p>维修小时数：</p>
              <div class="">
                <a-input value="5个小时" placeholder="" style="width: 320px" @search="onSearch" />
              </div>
            </div>
          </div>
          <div class="edit-con-foot-4">
          ...
          <div class="edit-con-foot-2">
            <div class="edit-con-foot-2-input">
              <p>维修人员数量：</p>
              <div class="">
                <a-input value="5个人" placeholder="" style="width: 320px" @search="onSearch" />
              </div>
            </div>
          </div>
          <div class="edit-con-foot-2">
            <div class="edit-con-foot-2-input">
              <p>申报人：</p>
              <div class="">
                <a-input value="张三" placeholder="" style="width: 320px" @search="onSearch" />
              </div>
            </div>
          </div>
          <div class="edit-con-foot-2">
            <div class="edit-con-foot-2-input">
              <p>报修单位：</p>
              <div class="">
                <a-input value="××××" placeholder="" style="width: 320px" @search="onSearch" />
              </div>
            </div>
          </div>
          <div class="edit-con-foot-4">
